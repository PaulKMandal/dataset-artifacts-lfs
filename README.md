...
Project by Kaj Bostrom, Jifan Chen, and Greg Durrett. Code by Kaj Bostrom and Jifan Chen. Modified for this submission.
...
See [`REPRODUCIBILITY.md`](REPRODUCIBILITY.md) for the full environment setup, preflight checks, smoke run, minimum panel, full panel, output layout, and validation commands.
