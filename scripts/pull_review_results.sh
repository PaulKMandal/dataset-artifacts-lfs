...
SERVER="${1:-${DATASET_ARTIFACTS_SERVER:-rhel-test}}"
REMOTE_ROOT="${2:-${DATASET_ARTIFACTS_REMOTE_RESULTS_DIR:-/home/rhel/Projects/dataset-artifacts/results/round3e_electra_small}}"
